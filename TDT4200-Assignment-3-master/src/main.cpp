...
void marianiSilver(struct job marianiParameters)
{
	...
	std::complex<double> const &cmin = marianiParameters.cmin;
	std::complex<double> const &dc = marianiParameters.dc;
	unsigned int const atY = marianiParameters.atY;
	unsigned int const atX = marianiParameters.atX;
	unsigned int const blockSize = marianiParameters.blockSize;
...
void addFunction(std::vector<std::vector<int>> &dwellBuffer,
					std::complex<double> const &cmin,
					std::complex<double> const &dc,
					unsigned int const atY,
					unsigned int const atX,
